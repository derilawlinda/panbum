...
use app\models\PekPengsumur;

/**
 * app\models\PekPengsumurSearch represents the model behind the search form about `app\models\PekPengsumur`.
 */
 class PekPengsumurSearch extends PekPengsumur
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id_pengsumur' => $this->id_pengsumur,
