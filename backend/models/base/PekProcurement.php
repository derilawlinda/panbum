...
/**
 * This is the base model class for table "pek_procurement".
 *
 * @property string $id
 ...
 */
class PekProcurement extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\PekProcurementQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\PekProcurementQuery(get_called_class());
    }
}
