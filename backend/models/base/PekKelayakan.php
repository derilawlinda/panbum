...
/**
 * This is the base model class for table "pek_kelayakan".
 *
 * @property string $id_kelayakan
 ...
 */
class PekKelayakan extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \app\models\PekKelayakanQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\PekKelayakanQuery(get_called_class());
    }
}
