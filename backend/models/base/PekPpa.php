...
/**
 * This is the base model class for table "pek_ppa".
 *
 * @property string $id
 ...
 */
class PekPpa extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\PekPpaQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\PekPpaQuery(get_called_class());
    }
}
