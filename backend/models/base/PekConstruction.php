...
/**
 * This is the base model class for table "pek_construction".
 *
 * @property string $id
 ...
 */
class PekConstruction extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\PekConstructionQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\PekConstructionQuery(get_called_class());
    }
}
