...
/**
 * This is the base model class for table "pek_overallepc".
 *
 * @property string $id
 ...
 */
class PekOverallepc extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\PekOverallepcQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\PekOverallepcQuery(get_called_class());
    }
}
