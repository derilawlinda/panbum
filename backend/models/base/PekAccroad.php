...
/**
 * This is the base model class for table "pek_accroad".
 *
 * @property string $id_accroad
 ...
 */
class PekAccroad extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \app\models\PekAccroadQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\PekAccroadQuery(get_called_class());
    }
}
