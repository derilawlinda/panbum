...
/**
 * This is the base model class for table "pek_cod".
 *
 ...
 */
class PekCod extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\PekCodQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\PekCodQuery(get_called_class());
    }
}
