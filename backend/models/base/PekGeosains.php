...
/**
 * This is the base model class for table "pek_geosains".
 *
 * @property string $id_geosains
 ...
 */
class PekGeosains extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \app\models\PekGeosainsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\PekGeosainsQuery(get_called_class());
    }
}
