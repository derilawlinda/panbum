...
/**
 * This is the base model class for table "pek_konssipil".
 *
 * @property string $id_konssipil
 ...
 */
class PekKonssipil extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\PekKonssipilQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\PekKonssipilQuery(get_called_class());
    }
}
