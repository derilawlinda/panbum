...
use app\models\PekUjimonsumur;

/**
 * app\models\PekUjimonsumurSearch represents the model behind the search form about `app\models\PekUjimonsumur`.
 */
 class PekUjimonsumurSearch extends PekUjimonsumur
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id_ujimonsumur' => $this->id_ujimonsumur,
