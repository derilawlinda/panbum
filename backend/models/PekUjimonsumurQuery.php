...
/**
 * This is the ActiveQuery class for [[\app\models\PekUjimonsumur]].
 *
 * @see \app\models\PekUjimonsumur
 */
class PekUjimonsumurQuery extends \yii\db\ActiveQuery {
    ...
    /**
     * @inheritdoc
     * @return \app\models\PekUjimonsumur[]|array
     */
    ...
    /**
     * @inheritdoc
     * @return \app\models\PekUjimonsumur|array|null
     */
    ...
    public function latest($id_unit) {
        ...
        if (count($query) > 0) {
            ...
            return array(
                'id_ujimonsumur' => "<span class='label label-danger'>No Data</span>",
