...
use app\models\PekKonssipil;

/**
 * app\models\PekKonssipilSearch represents the model behind the search form about `app\models\PekKonssipil`.
 */
 class PekKonssipilSearch extends PekKonssipil
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id_konssipil' => $this->id_konssipil,
