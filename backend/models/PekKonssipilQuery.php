...
/**
 * This is the ActiveQuery class for [[\app\models\PekKonssipil]].
 *
 * @see \app\models\PekKonssipil
 */
class PekKonssipilQuery extends \yii\db\ActiveQuery {
    ...
    /**
     * @inheritdoc
     * @return \app\models\PekKonssipil[]|array
     */
    ...
    /**
     * @inheritdoc
     * @return \app\models\PekKonssipil|array|null
     */
    ...
    public function latest($id_unit) {
        ...
        if (count($query) > 0) {
            ...
            return array(
                'id_konssipil' => "<span class='label label-danger'>No Data</span>",
