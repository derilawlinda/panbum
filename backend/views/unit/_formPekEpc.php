<div class="form-group" id="add-pek-epc">
<?php
...
echo TabularForm::widget([
    ...
    'attributes' => [
        'id_epc' => ['type' => TabularForm::INPUT_HIDDEN, 'visible' => false],
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  'Delete', 'onClick' => 'delRowPekEpc(' . $key . '); return false;', 'id' => 'pek-epc-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . 'Add Pek Epc', ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowPekEpc()']),
        ]
    ]
]);
echo  "    </div>\n\n";
