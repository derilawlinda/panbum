                    ...
                    <table class="table borderless">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1"><?= $form->field($modelUnit, 'investasi')->textInput(['placeholder' => 'Rp.'])->label(false) ?></td>
                            </tr>
                            <tr>
                        ...
                        <table class="table borderless">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-2" style="padding-bottom: 43px;"><?= $form->field($modelPengembang, 'alamat')->textArea(['rows' => 3, 'maxlength' => true, 'placeholder' => 'Alamat'])->label(false) ?></td>
                                </tr>
                    ...
                    <table class="table table-small">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1">
                                    <?= $modelTanah["file"] ? Html::a("Download", ['download', 'file_name' => 'Akta Tanah/' . $modelTanah["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Akta Tanah/' . $modelTanah["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                            ...
                            <tr>
                                ...
                                <td colspan="4" class="col-sm-1"><?= $form->field($modelTanah, 'remark')->textInput(['placeholder' => 'Catatan'])->label(false) ?></td>	
                            ...
                            <tr>
                                ...
                                <td colspan="4" class="col-sm-1"><?= $form->field($modelLahan, 'remark')->textInput(['placeholder' => 'Catatan'])->label(false) ?></td>	
                            ...
                            <tr>
                                <td class="col-sm-1">Catatan</td>
                                <td colspan="4" class="col-sm-1"><?= $form->field($modelProduksi, 'remark')->textInput(['maxlength' => true, 'placeholder' => 'Catatan'])->label(false) ?></td>	
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1">
                                    <?= $modelIzin["iup_file"] ? Html::a("Download", ['Download', 'file_name' => 'Izin/' . $modelIzin["iup_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Izin/' . $modelIzin["iup_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                    <?=
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1">
                                    <?= $modelIzin["ijl_file"] ? Html::a("Download", ['download', 'file_name' => 'Izin/' . $modelIzin["ijl_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Izin/' . $modelIzin["ijl_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                    <?=
                            ...
                            <tr>
                                ...
                                <?= $modelIzin["ippkh_file"] ? Html::a("Download", ['download', 'file_name' => 'Izin/' . $modelIzin["ippkh_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Izin/' . $modelIzin["ippkh_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                <td class="col-sm-1"><?=
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1">
                                    <?= $modelIzin["imb_file"] ? Html::a("Download", ['download', 'file_name' => 'Izin/' . $modelIzin["imb_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Izin/' . $modelIzin["imb_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                    <?=
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1">
                                    <?= $modelIzin["amdal_file"] ? Html::a("Download", ['download', 'file_name' => 'Izin/' . $modelIzin["amdal_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Liaht", ['view-pdf', 'file_name' => 'Izin/' . $modelIzin["amdal_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                    <?=
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1">
                                    <?= $modelIzin["imka_file"] ? Html::a("Download", ['download', 'file_name' => 'Izin/' . $modelIzin["imka_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Izin/' . $modelIzin["imka_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                    <?=
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1">
                                    <?= $modelIzin["simaksi_file"] ? Html::a("Download", ['download', 'file_name' => 'Izin/' . $modelIzin["simaksi_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Izin/' . $modelIzin["simaksi_file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                    <?=
                            ...
                            <tr>
                                <td class="col-sm-1">Catatan</td>
                                <td colspan="4" class="col-sm-1"><?= $form->field($modelIzin, 'remark')->textInput(['maxlength' => true, 'placeholder' => 'Catatan'])->label(false) ?></td>	
                            </tr>
                            <tr>
                                <td class="data col-sm-1"><strong>Sosial</strong></td>
                                <td colspan="6" style="vertical-align:top;height:150px;" class="col-sm-1"> <?=
                                    $form->field($modelSosial, 'sosial_text')->textArea([ 'rows' => '6',
                        ...
                        <table class="table borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-sm-1"><?= $modelPekGeosains["file"] ? Html::a("Download", ['download', 'file_name' => 'Penyelidikan Geosains/' . $modelPekGeosains["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Penyelidikan Geosains/' . $modelPekGeosains["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>                                     
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekEksplorasi["file"] ? Html::a("Download", ['download', 'file_name' => 'Pemboran Sumur Eksplorasi/' . $modelPekEksplorasi["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Pemboran Sumur Eksplorasi/' . $modelPekEksplorasi["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?> 
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekKelayakan["file"] ? Html::a("Download", ['download', 'file_name' => 'Studi Kelayakan/' . $modelPekKelayakan["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Studi Kelayakan/' . $modelPekKelayakan["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?> 
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekPpa["file"] ? Html::a("Download", ['download', 'file_name' => 'PPA/' . $modelPekPpa["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'PPA/' . $modelPekPpa["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?> 
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekUjimonsumur["file"] ? Html::a("Download", ['download', 'file_name' => 'Uji Monitoring Sumur/' . $modelPekUjimonsumur["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Uji Monitoring Sumur/' . $modelPekUjimonsumur["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?> 
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekPengsumur["file"] ? Html::a("Download", ['download', 'file_name' => 'Pengembangan Sumur Eksploitasi/' . $modelPekPengsumur["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Lihat", ['view-pdf', 'file_name' => 'Pengembangan Sumur Eksploitasi/' . $modelPekPengsumur["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekKonssipil["file"] ? Html::a("Download", ['download', 'file_name' => 'Konstruksi Sipil/' . $modelPekKonssipil["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']).'|'.Html::a("Download", ['download', 'file_name' => 'Konstruksi Sipil/' . $modelPekKonssipil["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekAccroad["file"] ? Html::a("Download", ['download', 'file_name' => 'Access Road/' . $modelPekAccroad["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekEngineering["file"] ? Html::a("Download", ['download', 'file_name' => 'Engineering/' . $modelPekEngineering["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekProcurement["file"] ? Html::a("Download", ['download', 'file_name' => 'Procurement/' . $modelPekProcurement["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekConstruction["file"] ? Html::a("Download", ['download', 'file_name' => 'Construction/' . $modelPekConstruction["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekOverallepc["file"] ? Html::a("Download", ['download', 'file_name' => 'Overall Progress EPC/' . $modelPekOverallepc["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekTransmisi["file"] ? Html::a("Download", ['download', 'file_name' => 'Transmisi/' . $modelPekTransmisi["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                        <?=
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1">
                                        <?= $modelPekCod["file"] ? Html::a("Download", ['download', 'file_name' => 'COD/' . $modelPekCod["file"], 'id_unit' => $modelUnit->id_unit], ['target' => '#']) : ""; ?>
                                    ...
                                    <td rowspan="2" class="col-sm-1 foto"><?=
                                        $form->field($modelFoto, 'peta')->widget(FileInput::classname(), [
                                            'pluginOptions' => [
                                                ...
                                                'defaultPreviewContent' => ($modelFoto->peta) ? Html::img('../../uploads/' . $modelWkp->nama . '-' . $modelPltp->nama_pltp . '-' . $modelUnit->no_unit . '/Peta/' . $modelFoto->peta, ['width' => 70, 'style' => 'margin-top:125px; margin-bottom:125px']) : "<i class='fa fa-file-image-o fa-5x' style='margin-top:120px; margin-bottom:120px'> </i>",
                                    ...
                                    <td class="col-sm-1 foto"><?=
                                        $form->field($modelFoto, 'name')->widget(FileInput::classname(), [
                                            'pluginOptions' => [
                                                ...
                                                'msgErrorClass' => 'alert alert-block alert-danger',
                                                'defaultPreviewContent' => ($modelFoto->name) ? Html::img('../../uploads/' . $modelWkp->nama . '-' . $modelPltp->nama_pltp . '-' . $modelUnit->no_unit . '/Foto/' . $modelFoto->name, ['width' => 70, 'style' => 'margin-top:25px;margin-bottom:25px;']) : "<i class='fa fa-file-image-o fa-5x' style='margin-top:25px;margin-bottom:25px'> </i>",
                                                'allowedFileExtensions' => ["jpg", "png", "gif"],
                                                'previewSettings' => [
                                                    'image' => ['width' => '50%', 'height' => '50%']
                                                ]
                                    ...
                                    <td class="col-sm-1 foto"> 
                                        ...
                                        $form->field($modelFoto, 'name2')->widget(FileInput::classname(), [
                                            ...
                                            'pluginOptions' => [
                                                ...
                                                'elErrorContainer' => '#kv-avatar-errors-2',
                                                'msgErrorClass' => 'alert alert-block alert-danger',
                                                'defaultPreviewContent' => ($modelFoto->name2) ? Html::img('../../uploads/' . $modelWkp->nama . '-' . $modelPltp->nama_pltp . '-' . $modelUnit->no_unit . '/Foto/' . $modelFoto->name2, ['width' => 70, 'style' => 'margin-top:25px;margin-bottom:25px;']) : "<i class='fa fa-file-image-o fa-5x' style='margin-top:25px;margin-bottom:25px'> </i>",
                                                'allowedFileExtensions' => ["jpg", "png", "gif"],
                                                'previewSettings' => [
                                                    'image' => ['width' => '50%', 'height' => '50%']
                                                ]
