<div class="form-group" id="add-pek-accroad">
<?php
...
echo TabularForm::widget([
    ...
    'attributes' => [
        'id_accroad' => ['type' => TabularForm::INPUT_HIDDEN, 'visible' => false],
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  'Delete', 'onClick' => 'delRowPekAccroad(' . $key . '); return false;', 'id' => 'pek-accroad-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . 'Add Pek Accroad', ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowPekAccroad()']),
        ]
    ]
]);
echo  "    </div>\n\n";
