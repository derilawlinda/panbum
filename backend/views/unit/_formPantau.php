						...
						<table class="table table-small">
							...
							<tbody>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelTanah, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelIzin, 'iup_file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
									...
									<td colspan="3" class="col-sm-1"><?php echo DatePicker::widget([
																		'model' => $modelIzin,
																		'attribute' => 'iup_awal',
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelIzin, 'ijl_file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelIzin, 'ippkh_file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelIzin, 'imb_file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelIzin, 'amdal_file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelIzin, 'imka_file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelIzin, 'simaksi_file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td colspan="6" style="vertical-align:top;height:150px;" class="col-sm-1"> <?= $form->field($modelSosial, 'sosial_text')->textArea([ 'rows' => '6',
																																'placeholder' => 'Data sosial'])->label(false) ?></td>
								</tr>
						...
						<table class="table borderless">
							...
							<tbody>
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekGeosains, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekEksplorasi, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekKelayakan, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekPpa, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekUjimonsumur, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekPengsumur, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekKonssipil, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekAccroad, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekEngineering, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekProcurement, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekConstruction, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekOverallepc, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekTransmisi, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelPekCod, 'file')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'showCaption' => false,
																'showRemove' => false,
																'showUpload' => false,
			...
			<div class="row">
					<div class="box box-solid">
						...
						<table class="table borderless">
							...
							<tbody>
								<tr>
									<td rowspan="2" class="col-sm-1 foto"><?= $form->field($modelWkp, 'peta')->widget(FileInput::classname(), [
														'pluginOptions' => [
									...
									<td class="col-sm-1 foto"><?= $form->field($modelFoto, 'name')->widget(FileInput::classname(), [
														'pluginOptions' => [
																'uploadUrl' => Url::to(['uploadfoto']),
																'maxFileCount' => 1,
																'maxFileSize' =>1500,
