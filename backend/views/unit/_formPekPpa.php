<div class="form-group" id="add-pek-ppa">
<?php
    ...
    'attributes' => [
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  'Delete', 'onClick' => 'delRowPekPpa(' . $key . '); return false;', 'id' => 'pek-ppa-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . 'Add Pek Ppa', ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowPekPpa()']),
        ]
    ]
]);
echo  "    </div>\n\n";
