                    ...
                    <table class="table borderless">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1"> <?= $form->field($modelUnit, 'no_unit')->textInput(['placeholder' => 'No Unit'])->label(false) ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1"><?= $form->field($modelUnit, 'tahap')->textInput(['placeholder' => 'Tahap Pengembangan'])->label(false) ?></td>
                    ...
                    <table class="table table-small">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1"><?= $form->field($modelTanah, 'status_tanah')->textInput(['placeholder' => 'Status'])->label(false) ?></td>	
                                <td class="col-sm-1">Tahun</td>
                                <td colspan="2" class="col-sm-1"><?= $form->field($modelTanah, 'status_tahun')->textInput(['placeholder' => 'Tahun'])->label(false) ?></td>	
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1"><?=
                                    $form->field($modelTanahFile, 'nama')->widget(FileInput::classname(), [
                                        'pluginOptions' => [
                                            'showCaption' => false,
                                            'showRemove' => false,
                                            'showUpload' => false,
                            ...
                            <tr>
                                <td rowspan="4" class="data col-sm-1"><strong>DED & RAB</strong></td>
                                <td class="col-sm-1">Nama Perencana</td>
                                <td colspan="4" class="col-sm-1"><?= $form->field($modelDed, 'nama_perencana')->textInput(['maxlength' => true, 'placeholder' => 'Nama Perencana'])->label(false) ?></td>		

                            </tr>
                            <tr>

                                <td class="col-sm-1">Alamat</td>
                                <td colspan="4" class="col-sm-1"><?= $form->field($modelDed, 'alamat')->textInput(['maxlength' => true, 'placeholder' => 'Alamat'])->label(false) ?></td>	

                            </tr>
                            <tr>
                                <td class="col-sm-1">No. Kontrak</td>
                                <td colspan="3" class="col-sm-1"><?= $form->field($modelDed, 'no_kontrak')->textInput(['maxlength' => true, 'placeholder' => 'No.Kontrak'])->label(false) ?></td>
                                <td class="col-sm-1"><?=
                                    $form->field($modelDedFile, 'nama')->widget(FileInput::classname(), [
                                        'pluginOptions' => [
                                            'showCaption' => false,
                                            'showRemove' => false,
                                            'showUpload' => false,
                            ...
                            <tr>
                                <td class="col-sm-2">Tgl. Penyusunan DED</td>
                                <td colspan="4" class="col-sm-1"><?php
                                    echo DatePicker::widget([
                                        'model' => $modelDed,
                                        'attribute' => 'tgl_awal_ded',
                                        'attribute2' => 'tgl_akhir_ded',
                            ...
                            <tr>
                                ...
                                <td colspan="6" style="vertical-align:top;height:150px;" class="col-sm-1"> <?=
                                    $form->field($modelSosial, 'sosial_text')->textArea([ 'rows' => '6',
                                        'placeholder' => 'Data sosial',
                                        'style' => 'height: 150px;'])->label(false)
                                    ?></td>
                            </tr>
                ...
                <div class="box box-solid">
                    <div class="box-body">
                        <table class="table borderless">
                            ...
                            <tbody>
                                <tr>
                                    <td rowspan="2" class="col-sm-1 foto">UploadPeta</td>
                                    <td class="col-sm-1">Foto1</td>
                                </tr>
                                <tr>

                                    <td class="col-sm-1"> Foto2</td>
                        ...
                        <table class="table borderless">
                            <thead class="thead">
                                <tr class="trhead" >
                                    ...
                                    <th style="vertical-align:middle;" rowspan="3"> Produk Akhir </th>
                                </tr>
                                <tr class="trhead">
                            ...
                            <tbody>
                                <tr>
                                    <td class="col-sm-3 right"><strong>Pelelangan</strong></td>
