                        ...
                        <table class="table borderless">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1"><?= $form->field($modelPengembang, 'dirut')->textInput(['disabled' => 'disabled', 'maxlength' => true, 'placeholder' => 'Direktur Utama'])->label(false) ?></td>
                                </tr>
                                <tr>
                                    <td class="col-sm-1 right"><strong>Alamat</strong></td>
                                    <td class="col-sm-2" style="padding-bottom: 43px;"><?= $form->field($modelPengembang, 'alamat')->textArea(['disabled' => 'disabled', 'rows' => 3, 'maxlength' => true, 'placeholder' => 'Alamat'])->label(false) ?></td>
                                </tr>
                    ...
                    <table class="table table-small">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-1">
                                    <?= !empty($modelIzin->iup_file) ? Html::a('Link', ['/site/test'], ['target' => '_blank']) : "" ?>
                                    <?=
