						...
						<table class="table borderless">
							<tbody>
								<tr>
									...
									<td class="col-sm-1 nopadding"><?= $form->field($modelWkp, 'id_wkp')
											->dropDownList(
												$wkpList,
												[
												'onchange' => '
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelUnit, 'id_pltp')
											->dropDownList(
												$pltpList,
												['prompt' => 'Pilih PLTP..',
												 'id' => 'pltpdropdown',
									...
									<td rowspan="7" class="col-sm-1 header-isi">
                                                                            <?= $form->field($modelUnit, 'attr_status')->radioList(array(1=>'Ya',0=>'Tidak')); ?>
                                                                            <?= $form->field($modelUnit, 'remark')->textArea(['placeholder'=>'Catatan','class'=>'commentClass'])->label(false) ?>
									</td>
								</tr>
								<tr>
									<td class="col-sm-1 right"><strong>No Unit</strong></td>
									<td class="col-sm-1"> <?= $form->field($modelUnit, 'no_unit')
											->dropDownList(
												$unitList,
												['prompt' => 'Pilih Unit..',
												 'id' => 'unitdropdown',
								...
								<tr>
									...
									<td class="col-sm-1"><?= $form->field($modelUnit, 'tahap')->dropDownList(
									["Lelang"=>"Lelang",
									 "Eksplorasi"=>"Eksplorasi",
									 "Eksploitasi"=>"Eksploitasi",
									 "Pemanfaatan"=>"Pemanfaatan"],
									['prompt' => 'Pilih Tahapan..'
		...
		<div class="col-sm-12">
					...
					<div class="box box-solid">
						...
						<table class="table borderless">
							...
							<tbody>
								<tr>
									<td rowspan="2" class="col-sm-5 foto" style="padding-top:100px;text-align:center"><?php echo !empty($modelFoto->peta) ? Html::img('../../uploads/'.$modelWkp->nama.'-'.$modelPltp->nama_pltp.'-'.$modelUnit->no_unit.'/Peta/'.$modelFoto->peta, ['height'=>200]) : Html::img('image/map.png', ['height'=>200]); ?></td>
                                                                        <td class="col-sm-4 foto" style="text-align: center;padding-top: 5px">
                                                                            <?php echo !empty($modelFoto->name) ? Html::img('../../uploads/'.$modelWkp->nama.'-'.$modelPltp->nama_pltp.'-'.$modelUnit->no_unit.'/Foto/'.$modelFoto->name, ['height'=>200]) : "<i class='fa fa-file-image-o fa-5x' style='padding-top:50px'> </i>"; ?></td>
                                                                        </td>
						...
						<table class="table table-small">
							...
							<tbody>
								...
								<tr>
									...
									<td ><?php echo (!empty($modelTanah["file"])) ? Html::a("Download", ['download','file_name' => 'Akta Tanah/'.$modelTanah["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "";  ?></td>
								...
								<tr>
									...
									<td>IUP/IPB</td>
									<td class="col-sm-1" ><?= $modelIzin->iup_file ? Html::a("Download", ['download','file_name' => 'Izin/'.$modelIzin->iup_file ,'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?></td>
                                                                        <td colspan="3" class="col-sm-3"><?php echo DatePicker::widget([
																		'model' => $modelIzin,
																		'attribute' => 'iup_awal',
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelIzin->ijl_file ? Html::a("Download", ['download','file_name' => 'Izin/'.$modelIzin->ijl_file ,'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>		
									<td colspan="3" class="col-sm-3"><?php echo DatePicker::widget([
																		'model' => $modelIzin,
																		'attribute' => 'ijl_awal',
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelIzin->ippkh_file ? Html::a("Download", ['download','file_name' => 'Izin/'.$modelIzin->ippkh_file ,'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?></td>		
									<td colspan="3" class="col-sm-3"><?php echo DatePicker::widget([
																		'model' => $modelIzin,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelIzin->imb_file ? Html::a("Download", ['download','file_name' => 'Izin/'.$modelIzin->imb_file ,'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?></td>		
									<td colspan="3" class="col-sm-3"><?php echo DatePicker::widget([
																		'model' => $modelIzin,
																		'attribute' => 'imb_awal',
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelIzin->amdal_file ? Html::a("Download", ['download','file_name' => 'Izin/'.$modelIzin->amdal_file ,'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?></td>		
									<td colspan="3" class="col-sm-3"><?php echo DatePicker::widget([
																		'model' => $modelIzin,
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelIzin->imka_file ? Html::a("Download", ['download','file_name' => 'Izin/'.$modelIzin->imka_file ,'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?></td>		
									<td colspan="3" class="col-sm-3"><?php echo DatePicker::widget([
																		'model' => $modelIzin,
																		'attribute' => 'imka_awal',
								...
								<tr>
									<td >Simaksi</td>
									<td ><?= $modelIzin->simaksi_file ? Html::a("Download", ['download','file_name' => 'Izin/'.$modelIzin->simaksi_file ,'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?></td>		
									<td colspan="3" class="col-sm-3" ><?php echo DatePicker::widget([
																		'model' => $modelIzin,
						...
						<table class="table borderless">
							...
							<tbody>
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekGeosains["file"] ? Html::a("Download", ['download','file_name' => 'Penyelidikan Geosains/'.$modelPekGeosains["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
									...
									<td class="col-sm-1"><?= $form->field($modelPekGeosains, 'target')->textInput(['maxlength' => true, 'placeholder' => 'Target'])->label(false) ?></td>
                                                                        <td class="col-sm-1"><?= $form->field($modelPekGeosains, 'status')->radioList([1 => 'Ya', 0 => 'Tidak'],['class'=>'col-sm-offset-3']); ?></td>
                                                                        <td class="col-sm-1"><?= $form->field($modelPekGeosains, 'remark')->textArea(['placeholder'=>'Catatan','class'=>'commentClass col-sm-offset-3'])->label(false) ?></td>
								</tr>
								<tr>
									<td class="col-sm-1 right"><strong>Pembangunan Sumur Eskplorasi</strong></td>
									<td class="col-sm-1"><?= $modelPekEksplorasi["file"] ? Html::a("Download", ['download','file_name' => 'Pemboran Sumur Eksplorasi/'.$modelPekEksplorasi["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekKelayakan["file"] ? Html::a("Download", ['download','file_name' => 'Studi Kelayakan/'.$modelPekKelayakan["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekPpa["file"] ? Html::a("Download", ['download','file_name' => 'PPA/'.$modelPekPpa["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekUjimonsumur["file"] ? Html::a("Download", ['download','file_name' => 'Uji Monitoring Sumur/'.$modelPekUjimonsumur["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekPengsumur["file"] ? Html::a("Download", ['download','file_name' => 'Pengembangan Sumur Eksploitasi/'.$modelPekPengsumur["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekKonssipil["file"] ? Html::a("Download", ['download','file_name' => 'Konstruksi Sipil/'.$modelPekKonssipil["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekAccroad["file"] ? Html::a("Download", ['download','file_name' => 'Access Road/'.$modelPekAccroad["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekEngineering["file"] ? Html::a("Download", ['download','file_name' => 'Engineering/'.$modelPekEngineering["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekProcurement["file"] ? Html::a("Download", ['download','file_name' => 'Procurement/'.$modelPekProcurement["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekConstruction["file"] ? Html::a("Download", ['download','file_name' => 'Construction/'.$modelPekConstruction["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekOverallepc["file"] ? Html::a("Download", ['download','file_name' => 'Overall Progress EPC/'.$modelPekOverallepc["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekTransmisi["file"] ? Html::a("Download", ['download','file_name' => 'Transmisi/'.$modelPekTransmisi["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
								...
								<tr>
									...
									<td class="col-sm-1"><?= $modelPekCod["file"] ? Html::a("Download", ['download','file_name' => 'COD/'.$modelPekCod["file"],'id_unit'=>$modelUnit->id_unit],['target' => '#']) : "<span class='label label-danger'>No File</span>";  ?> </td>
						...
						<table class="table borderless">
							...
							<tbody>
								<tr>
									...
									<td class="col-sm-4" colspan="2"><?php echo DatePicker::widget([
																		'model' => $modelWaktu,
								...
								<tr>
									...
									<td class="col-sm-1" colspan="2"><?php echo DatePicker::widget([
																		'model' => $modelWaktu,
