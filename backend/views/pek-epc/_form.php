...
<div class="pek-epc-form">

    <?php $form = ActiveForm::begin(['layout' => 'horizontal',
									'id'=> 'pek-epc-form-id',
									'action' => 'index.php?r=pek-epc/create']); ?>
...
$('form#pek-epc-form-id').on('beforeSubmit',function(e)
		{
			var form = $(this);
			var formData = new FormData();
			
			$.each($('form#pek-epc-form-id :file'), function(i, file) {
				formData.append(file.name, file.files[0])
			}); 
			$.each($('form#pek-epc-form-id :input:not(:file)'), function(i, elm) {
