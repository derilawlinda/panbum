...
<div class="pek-geosains-form">
    ...
    <?php $form = ActiveForm::begin(['layout' => 'horizontal',
									'id'=> 'pek-geosains-form-id',
									'action' => 'index.php?r=pek-geosains/create']); ?>
...
$('form#pek-geosains-form-id').on('beforeSubmit',function(e)
		{
			var form = $(this);
			var formData = new FormData();
			
			$.each($('form#pek-geosains-form-id :file'), function(i, file) {
				formData.append(file.name, file.files[0])
			}); 
			$.each($('form#pek-geosains-form-id :input:not(:file)'), function(i, elm) {
