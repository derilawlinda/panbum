...
/* @var $model app\models\PekTransmisiSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-pek-transmisi-search">
    ...
    <?= $form->field($model, 'id_transmisi')->textInput(['maxlength' => true, 'placeholder' => 'Id Transmisi']) ?>
