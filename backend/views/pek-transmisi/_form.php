...
<div class="pek-transmisi-form">

    <?php $form = ActiveForm::begin(['layout' => 'horizontal',
									'id'=> 'pek-transmisi-form-id',
									'action' => 'index.php?r=pek-transmisi/create']); ?>
...
$('form#pek-transmisi-form-id').on('beforeSubmit',function(e)
		{
			var form = $(this);
			var formData = new FormData();
			
			$.each($('form#pek-transmisi-form-id :file'), function(i, file) {
				formData.append(file.name, file.files[0])
			}); 
			$.each($('form#pek-transmisi-form-id :input:not(:file)'), function(i, elm) {
