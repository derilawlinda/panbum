...
<div class="pek-ujimonsumur-form">

   <?php $form = ActiveForm::begin(['layout' => 'horizontal',
									'id'=> 'pek-ujimonsumur-form-id',
									'action' => 'index.php?r=pek-ujimonsumur/create']); ?>
...
$('form#pek-ujimonsumur-form-id').on('beforeSubmit',function(e)
		{
			var form = $(this);
			var formData = new FormData();
			
			$.each($('form#pek-ujimonsumur-form-id :file'), function(i, file) {
				formData.append(file.name, file.files[0])
			}); 
			$.each($('form#pek-ujimonsumur-form-id :input:not(:file)'), function(i, elm) {
