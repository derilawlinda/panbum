...
/* @var $model app\models\PekKelayakanSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-pek-kelayakan-search">
    ...
    <?= $form->field($model, 'id_kelayakan')->textInput(['maxlength' => true, 'placeholder' => 'Id Kelayakan']) ?>
