...
<div class="pek-kelayakan-form">

  
    <?php $form = ActiveForm::begin(['layout' => 'horizontal',
									'id'=> 'pek-kelayakan-form-id',
									'action' => 'index.php?r=pek-kelayakan/create']); ?>
...
$('form#pek-kelayakan-form-id').on('beforeSubmit',function(e)
		{
			var form = $(this);
			var formData = new FormData();
			
			$.each($('form#pek-kelayakan-form-id :file'), function(i, file) {
				formData.append(file.name, file.files[0])
			}); 
			$.each($('form#pek-kelayakan-form-id :input:not(:file)'), function(i, elm) {
