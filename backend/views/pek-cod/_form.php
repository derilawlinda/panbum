...
<div class="pek-cod-form">

    <?php $form = ActiveForm::begin(['layout' => 'horizontal',
									'id'=> 'pek-cod-form-id',
									'action' => 'index.php?r=pek-cod/create']); ?>
...
$('form#pek-cod-form-id').on('beforeSubmit',function(e)
		{
			var form = $(this);
			var formData = new FormData();
			
			$.each($('form#pek-cod-form-id :file'), function(i, file) {
				formData.append(file.name, file.files[0])
			}); 
			$.each($('form#pek-cod-form-id :input:not(:file)'), function(i, elm) {
