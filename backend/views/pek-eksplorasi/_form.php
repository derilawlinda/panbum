...
<div class="pek-eksplorasi-form">

      <?php $form = ActiveForm::begin(['layout' => 'horizontal',
									'id'=> 'pek-eksplorasi-form-id',
									'action' => 'index.php?r=pek-eksplorasi/create']); ?>
...
$('form#pek-eksplorasi-form-id').on('beforeSubmit',function(e)
		{
			var form = $(this);
			var formData = new FormData();
			
			$.each($('form#pek-eksplorasi-form-id :file'), function(i, file) {
				formData.append(file.name, file.files[0])
			}); 
			$.each($('form#pek-eksplorasi-form-id :input:not(:file)'), function(i, elm) {
