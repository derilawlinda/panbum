...
<div class="pek-konssipil-form">

    <?php $form = ActiveForm::begin(['layout' => 'horizontal',
									'id'=> 'pek-konssipil-form-id',
									'action' => 'index.php?r=pek-konssipil/create']); ?>
...
$('form#pek-konssipil-form-id').on('beforeSubmit',function(e)
		{
			var form = $(this);
			var formData = new FormData();
			
			$.each($('form#pek-konssipil-form-id :file'), function(i, file) {
				formData.append(file.name, file.files[0])
			}); 
			$.each($('form#pek-konssipil-form-id :input:not(:file)'), function(i, elm) {
