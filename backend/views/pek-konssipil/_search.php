...
/* @var $model app\models\PekKonssipilSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-pek-konssipil-search">
    ...
    <?= $form->field($model, 'id_konssipil')->textInput(['maxlength' => true, 'placeholder' => 'Id Konssipil']) ?>
