...
<div class="pek-accroad-form">

    <?php $form = ActiveForm::begin(['layout' => 'horizontal',
									'id'=> 'pek-accroad-form-id',
									'action' => 'index.php?r=pek-accroad/create']); ?>
...
$('form#pek-accroad-form-id').on('beforeSubmit',function(e)
		{
			var form = $(this);
			var formData = new FormData();
			
			$.each($('form#pek-accroad-form-id :file'), function(i, file) {
				formData.append(file.name, file.files[0])
			}); 
			$.each($('form#pek-accroad-form-id :input:not(:file)'), function(i, elm) {
